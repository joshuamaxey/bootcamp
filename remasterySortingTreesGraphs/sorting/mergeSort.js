...
//^ Here is the logic behind mergeSort():
    ...
    // You can consider an empty array to be [trivially] sorted

//^ What is the time complexity of mergeSort()?

    // The time complexity of mergeSort() is O(n log n) in all cases: best, average, and worst. It is a divide-and-conquer sorting algorithm.
