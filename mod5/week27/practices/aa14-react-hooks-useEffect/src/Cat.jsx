...
const Cat = () => {
  ...
  useEffect(() => {
    const colorInterval = setInterval(() => {
      setColorIdx((prevIdx) => {
        const newIdx = ++prevIdx % COLORS.length; // in this case, th '++' operator before prevIdx will increment the value of the colorIndex (the prevIdx) by 1 BEFORE using it. This is called the pre-increment operator, meaning the increment happens before any operations are performed on the value being incremented.
        return newIdx;
      })
    }, delayChange);
